...
static const std::map<llm_arch, std::map<llm_tensor, const char *>> LLM_TENSOR_NAMES = {
        ...
        }, },
    {
     LLM_ARCH_FLORENCE2,         {
            ...
            { LLM_TENSOR_ENC_FFN_DOWN, "enc.blk.%d.ffn_down" },
            { LLM_TENSOR_ENC_FFN_UP, "enc.blk.%d.ffn_up" },
            { LLM_TNSOR_ENC_POS_EMBD, "enc.pos_embd" },
            { LLM_TNSOR_DEC_POS_EMBD, "dec.pos_embd" },
            { LLM_TNSOR_ENC_FINAL_NORM, "enc.blk.%d.final_norm" },
            { LLM_TNSOR_DEC_FINAL_NORM, "dec.blk.%d.final_norm" },
            { LLM_TNSOR_ENC_TOKEN_EMBD_NORM, "enc.token_embd_norm" },
            { LLM_TNSOR_DEC_TOKEN_EMBD_NORM, "dec.token_embd_norm" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    { LLM_TNSOR_ENC_POS_EMBD,            { LLM_TENSOR_LAYER_INPUT, GGML_OP_GET_ROWS }       },
    { LLM_TNSOR_DEC_POS_EMBD,            { LLM_TENSOR_LAYER_INPUT, GGML_OP_GET_ROWS }       },
    { LLM_TNSOR_ENC_FINAL_NORM,          { LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL }        },
    { LLM_TNSOR_DEC_FINAL_NORM,          { LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL }        },
    { LLM_TNSOR_ENC_TOKEN_EMBD_NORM,     { LLM_TENSOR_LAYER_INPUT, GGML_OP_MUL }            },
    { LLM_TNSOR_DEC_TOKEN_EMBD_NORM,     { LLM_TENSOR_LAYER_INPUT, GGML_OP_MUL }            },
};
